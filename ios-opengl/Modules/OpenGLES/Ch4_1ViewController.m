...
@implementation Ch4_1ViewController
...
-(void)initGLKit{
    ...
    //创建一个提供标准OpenGl ES 2.0着色语言程序的基础效果，并设置用于所有后续渲染的常量
    self.baseEffect = [[GLKBaseEffect alloc] init];
    self.baseEffect.light0.enabled = GL_TRUE;   //开启灯光1
    self.baseEffect.light0.diffuseColor = GLKVector4Make(0.9f,0.2f,0.7f,1.0f);//设置灯光漫反射颜色
    /*
     灯光位置
...
//    self.extraEffect.constantColor= GLKVector4Make(1.0f,1.0f,0.5f,0.0f);
