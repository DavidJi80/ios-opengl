...
@implementation GLSL3ViewController
...
- (void)compileShaders {
    // 生成一个顶点着色器对象
    GLuint vertexShader = [self compileShader:@"Glsl3Vertex" withType:GL_VERTEX_SHADER];
    // 生成一个片段着色器对象
    GLuint fragmentShader = [self compileShader:@"Glsl3Fragment" withType:GL_FRAGMENT_SHADER];
...
//    glUniform4f(vertexColorLoc, 0.7f, 1.0f, 0.7f, 1.0f);
